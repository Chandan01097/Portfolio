      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-500 dark:text-blue-400 mb-4">Portfolio</h3>
            <p className="text-gray-400 max-w-md">
              A passionate Computer Science Student based in Bhubaneswar, Odisha, exploring the frontiers of technology with a focus on AI/ML and web development.
            </p>
            
            <div className="mt-6 flex space-x-4">
              <a 
                href="#" 
                className="p-2 bg-gray-800 dark:bg-slate-800 rounded-full text-gray-400 hover:text-white hover:bg-blue-600 transition-colors duration-300"
                aria-label="GitHub"
              >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <button 
            onClick={scrollToTop}
            className="p-3 bg-blue-600 rounded-full text-white hover:bg-blue-700 transition-colors duration-300 animate-bounce"
